            ...
            <div class="row">
                <div class="col-12 px-0">
                    <div class="box-fiture">
                        ...
                        <a href="<?= base_url('profil/laporan_presensi_staf')?>" class="list-group-item border-0 bg-f5f5f5 shadow-none rounded-15 py-1 px-3 mb-3 mx-3">
                            <div class="row p-2">
                                <div class="d-flex col-auto align-items-center ">
                                    <div class="bg-ec3528 rounded-10 icon-box-profile d-flex justify-content-center align-items-center fs-3 text-light">
                                ...
                                <div class="col align-self-center p-0">
                                    <p class="mb-0 fw-bold size-14">Laporan Presensi Staf</p>
                                    <p class="text-secondary size-12">
                                        Data kehadiran staf
                                    </p>
                                </div>
