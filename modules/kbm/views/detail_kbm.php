                        ...
                        <div class="col-6 mx-auto">
                            <div class="card mb-3">
                                ...
                                <div class="card-body detail-kbm">
                                    <div class="row">
                                        <div class="col align-self-center ps-4 text-detail-kbm">
                                            <p class="mb-0 size-15 fw-medium">Jumlah Siswa</p>
                                            <p class="fw-normal text-secondary size-12">120 Siswa</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-6 mx-auto">
                            <div class="card mb-3">
                                ...
                                <div class="card-body detail-kbm">
                                    <div class="row">
                                        <div class="col align-self-center ps-4 text-detail-kbm">
                                            <p class="mb-0 size-15 fw-medium">Presensi Kelas</p>
                                            <p class="fw-normal text-secondary size-12">13 : 000</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
