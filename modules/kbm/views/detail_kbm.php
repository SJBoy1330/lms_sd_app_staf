                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col d-flex justify-content-center align-items-center flex-column">
                                        <a href="<?= base_url('kbm/presensi_siswa')?>" class="avatar avatar-50 rounded-18 avatar-presensi-inline">
                                    ...
                                    <div class="col d-flex justify-content-center align-items-center flex-column">
                                        <a href="<?= base_url('jurnal/detail_jurnal_guru')?>" class="avatar avatar-50 rounded-18 avatar-presensi-inline">
                                            <div class="circle-bg-top"></div>
                                            <div class="circle-bg-bottom"></div>
                        ...
                        <div class="list-group-item rounded-15 mb-1 shadow-sm position-relative overflow-hidden mb-3 p-3">
                            ...
                            <div class="row py-1 px-2 mt-2 mb-2 ">
                                ...
                                <div class="col align-self-center p-0 d-flex align-items-start flex-column">
                                    ...
                                    <p class="mb-0 fw-normal size-15">Kamis, 11 Januari 2021</p>
                                </div>
                            </div>
                            <div class="row py-1 px-2 mb-3">
                                ...
                                <div class="col align-self-center p-0 d-flex align-items-start flex-column">
                                    ...
                                    <p class="mb-0 fw-normal size-15">Kelas Abu Bakar</p>
                                </div>
                            </div>
                            <div class="row py-1 px-2 mb-3">
                                ...
                                <div class="col p-0 d-flex align-items-start flex-column">
                                    ...
                                    <p class="mb-0 fw-normal size-15">pendidikan jasmani, olahraga, dan kesehatan</p>
                                </div>
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group select-group"> 
                                ...
                                <select class="form-select form-select form-select-pribadi border-0 ps-2">
                                    <option>Pilih</option>
                                    <option value="B">Google Duo</option>
