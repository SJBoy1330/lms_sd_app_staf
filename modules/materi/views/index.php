<main class="h-100 py-0">
                ...
                <div class="wrapper-searching-tugas mb-3">
                    ...
                    <div class="row bg-white" style="width: 100vw;">
                        ...
                        <div class="col-2 d-flex justify-content-center align-items-center ps-0">
                            <button class="btn btn-secondary bg-dropdown filter-tugas border-0" data-bs-toggle="modal" data-bs-target="#filterTingkatKelas">
                    ...
                    <a href="<?= base_url('materi/detail_bab'); ?>" class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col align-self-center ps-0">
                                    <p class="mb-0 size-14 fw-normal">Materi Pelajaran 02</p>
                    ...
                    <a href="<?= base_url('materi/detail_bab'); ?>" class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col align-self-center ps-0">
                                    <p class="mb-0 size-14 fw-normal">Materi Pelajaran 03</p>
                    ...
                    <a href="<?= base_url('materi/detail_bab'); ?>" class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col align-self-center ps-0">
                                    <p class="mb-0 size-14 fw-normal">Materi Pelajaran 04</p>
                    ...
                    <a href="<?= base_url('materi/detail_bab'); ?>" class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col align-self-center ps-0">
                                    <p class="mb-0 size-14 fw-normal">Materi Pelajaran 05</p>
                    ...
                    <a href="<?= base_url('materi/detail_bab'); ?>" class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col align-self-center ps-0">
                                    <p class="mb-0 size-14 fw-normal">Materi Pelajaran 06</p>
                                    <p class="mb-0 size-13 fw-normal text-secondary">Staf Pengajar 6</p>
                                </div>
                                <div class="col-auto align-self-center ms-3">
                                    <button class="btn btn-md btn-link"><i class="fa-solid fa-chevron-right size-26 text-dark"></i></button>
                                </div>
        ...
        <!-- Filter Ujian Modal -->
        <div class="modal fade" id="filterTingkatKelas" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
