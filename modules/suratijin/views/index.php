        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row mt-3">
                    <div class="col">
                        <div class="mb-3">
                            <labe class="form-label title-3">Tanggal Awal</label>
                            <input type="date" class="form-control form-control-solid form-control-pribadi border-0" autocomplete="off">
                        </div>

                        <div class="mb-3">
                            <labe class="form-label title-3">Tanggal Akhir</label>
                            <input type="date" class="form-control form-control-solid form-control-pribadi border-0" autocomplete="off">
                        </div>
                    </div>
                </div>
